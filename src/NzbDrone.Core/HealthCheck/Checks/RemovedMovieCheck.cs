...
namespace NzbDrone.Core.HealthCheck.Checks
{
    ...
    public class RemovedSeriesCheck : HealthCheckBase, ICheckOnCondition<MovieUpdatedEvent>, ICheckOnCondition<MovieDeletedEvent>, ICheckOnCondition<MoviesDeletedEvent>
    {
